...
export default function OutletList() {
    ...
    if (isError) return <div className="text-red-500 p-8">Failed to load outlets.</div>;
                                        ...
                                        <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        This will permanently delete the outlet <span className="font-medium text-foreground">{outlet.name}</span>.
