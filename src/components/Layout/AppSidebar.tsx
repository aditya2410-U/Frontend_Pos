                            ...
                            {menuItems.map((item) => (
                                <SidebarMenuItem key={item.title}>
                                    <SidebarMenuButton
                                        ...
                                        className={isActive(item.url) ? "bg-foreground text-background hover:bg-foreground/90 hover:text-background data-[active=true]:bg-primary data-[active=true]:text-background" : ""}
                                    >
                                        <Link to={item.url}>
